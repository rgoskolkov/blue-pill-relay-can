...
#define BUTTON_GND_Pin GPIO_PIN_14
#define BUTTON_GND_GPIO_Port GPIOC
...
#define USART_MONITOR_TX_Pin GPIO_PIN_9
#define USART_MONITOR_TX_GPIO_Port GPIOA
#define USART_MONITOR_RX_Pin GPIO_PIN_10
#define USART_MONITOR_RX_GPIO_Port GPIOA
