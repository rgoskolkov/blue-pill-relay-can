...
- From CubeMX Src/ -> project/src/
  - usart.c               (MX_USART1_UART_Init, huart1)
...
1. Запуск сборки:
   - cd /Users/romanoskolkov/Desktop/cube/plue-pill-relay-modbus
   - pio run
2. Если сборка падает с undefined reference — пришлите вывод `pio run -v` и я подгоню недостающие символы (обычно huart1, MX_USART1_UART_Init, SystemClock_Config, MX_GPIO_Init и т.п.)
